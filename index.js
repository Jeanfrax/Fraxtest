//Código editado por Kuromi Owner
(async () => {
require("./settings")
...
let vcard = `BEGIN:VCARD\nVERSION:3.0\nN:; Frankito ❤️ Eliza;;;\nFN:.Frankito ❤️ Eliza\nORG: Frankito ❤️ Eliza\nTITLE:\nitem1.TEL;waid=51953616910:+51953616910\nitem1.X-ABLabel:Propietario 👑\nX-WA-BIZ-DESCRIPTION:ᴇsᴄʀɪʙɪ sᴏʟᴏ ᴘᴏʀ ᴄᴏsᴀs ᴅᴇʟ ʙᴏᴛ.\nX-WA-BIZ-NAME:Owner 👑\nEND:VCARD`
sock.sendMessage(fucker.from, { contacts: { displayName: '🎡 𝐊𝐔𝐑𝐎𝐌𝐈-𝐁𝐎𝐓 𝐎𝐅𝐂 🎡', contacts: [{ vcard }] }}, {quoted: call, ephemeralExpiration: 24*60*100, disappearingMessagesInChat: 24*60*100})
await sleep(8000)
...
serverMessageId: '', 
newsletterName: '🎡 𝐊𝐔𝐑𝐎𝐌𝐈-𝐁𝐎𝐓 𝐎𝐅𝐂 🎡' }, forwardingScore: 9999999, isForwarded: true, mentionedJid:[num], "externalAdReply": { 
"title": `乂 ＷＥＬＣＯＭＥ 乂`, 
"body": `${name.split("@")[0]}`, 
"previewType": "PHOTO", 
"thumbnailUrl": null,
...
let name = num
let usuario = anu.author
sock.sendMessage(anu.id, { text: `@${name.split("@")[0]} ${pickRandom(['Jeje ya no eres admin 🥲', 'jjjjj ya no eres admin 🤣'])}\n\n🫵 Acción echa por : @${usuario.split("@")[0]}`,
 contextInfo:{
 forwardedNewsletterMessageInfo: { 
newsletterJid: '120363296103096943@newsletter', 
serverMessageId: '', 
