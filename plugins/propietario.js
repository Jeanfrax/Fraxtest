...
┏╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍
┃• *Kuromi Owner te dio en 𝗍᥆𝗍ᥲᥣ:* ${dmt} 💎
┗╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍`)}

if (command == 'añadirxp' || command == 'darxp' || command == 'addxp') {
const pajak = 0;
let who;
if (m.isGroup) who = m.mentionedJid[0];
else who = m.chat;
...
┏╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍
┃• *Kuromi owner te dio en 𝗍᥆𝗍ᥲᥣ:* ${xp} exp
┗╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍`)}
...
if (command == 'SorpresaDiaria' || command == 'get') {
if (!/^https?:\/\//.test(text)) return m.reply('*https://www.facebook.com/100961214936160/posts/224236392608641/?mibextid=rS40aB7S9Ucbxw6v') 
